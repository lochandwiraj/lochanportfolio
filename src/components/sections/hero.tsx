        ...
        <div className="flex flex-col md:flex-row justify-between items-start pt-[10vh] pb-[10vh]">
          ...
          <div className="flex-1">
            <h1 
              ...
              style={{ fontSize: '11vw' }}
            >
              <div className="block">SOLVING</div>
              <div className="block translate-x-[6vw]">PROBLEMS</div>
              <div className="block translate-x-[12vw]">THAT ACTUALLY</div>
              <div className="block translate-x-[18vw]">MATTER</div>
            </h1>
          </div>

          <div className="mt-12 md:mt-0 md:max-w-[300px] lg:max-w-[400px] self-start md:pt-[2vw]">
            <p 
              className="text-[1rem] font-medium leading-[1.6] tracking-tight"
              style={{ fontFamily: 'Inter, sans-serif', color: '#000000' }}
            >
              A problem-solver who builds products with real impact— from AI-powered tools to fraud prevention systems to blockchain infrastructure. Currently raising for ventures that matter.
            </p>
          </div>
        </div>
      </div>
